programa
{
	...
	funcao questao7()
	{
		...
		enquanto(q>0)		
		{	
			/*De acordo com as regras de divisibilidade por 3, sabemos que um número é divisível 
			 * por 3 caso a soma dos algarismos também seja. Assim, vamos excluir todos os números 
			 * que são múltiplos de 3.
				6,9,12,15,18,..., 321,324,...*/
			se((cont==2 ou cont==3 ou cont==5 ou cont==7) ou (cont%1==0 e cont/cont==1 e cont%2!=0 e cont%3!=0 e cont%5!=0 e cont%7!=0))
